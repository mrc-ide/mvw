...
An interactive workshop to provide an overview of how to use :package: [malariasimulation] 
and the malariaverse to run context-specific simulations for a country or region.
