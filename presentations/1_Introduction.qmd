...
-   An introduction to the software packages implementing the model
    -   :package:\[malariasimulation\]
    -   :package:\[\]
    -   Please see websites and supporting documentation for help
-   A comprehensive overview of all malariaverse packages/features

::: footer
https://mrc-ide.github.io/malariasimulation https://mrc-ide.github.io/deterministic model..
:::
...
2.  Context-specific modelling
    ...
    -   Requires "the context" to be adequately captured :thinking:
...
-   Rainfall seasonality :umbrella:
-   Historical interventions
-   Epidemiological data (e.g. *Pf*Pr~2-10~, malaria cases)
-   Human population & demography :people_holding_hands:
...
-   Please always consider your use-case carefully :thinking:, it is likely you may
...
-   The Malariaverse aims to provide you with the tools to be able to make necessary improvements to site files and construct new ones from scratch :hammer_and_wrench:
