...
-   Calibration can be d when difficlut when results are dominated by stochasticy (low transmission, population is too small, calibrating to a sub-group in the populations etc.)

## Let's give it a try!

-   Run `mvw::run_tutorial("Calibration")`

![](images/Guinea-Pig-bike.jpg){fig-align="center"}
