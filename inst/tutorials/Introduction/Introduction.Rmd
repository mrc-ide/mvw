...
## Exploring a site file`r emo::ji("telescope")`
...
4.  Plot the *Pf*Pr~2-10~ estimated by the model (hint: the output `n_detect_` is the number positive and `n_` the number of individuals in a given age group).

5.  Overlay the Malaria Atlas Project estimates of *Pf*Pr~2-10~ onto your plot (see `$prevalence`).
...
-   Try changing the EIR argument in `site_parameters()` and re-running. What has changed?
